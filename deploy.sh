...
echo "8. Test the health endpoint: https://your-backend-url.vercel.app/api/health"
echo ""
...
echo "   Expected response: {\"status\":\"OK\",\"message\":\"Job Board API is running\"}"
echo "2. Test Frontend: Visit your frontend URL"
echo "3. Test all functionality:"
echo "   - User registration/login"
echo "   - Job browsing"
echo "   - Job applications"
echo "   - Admin functionality (admin@example.com / admin123)"
echo ""
...
echo "• If backend crashes, check database initialization"
echo "• Verify VERCEL=true environment variable is set"
echo ""

echo "🚨 Common Issues & Solutions:"
echo "============================="
echo "• 500 Internal Server Error: Check Vercel function logs"
echo "• CORS errors: Verify FRONTEND_URL environment variable"
echo "• Database errors: Ensure VERCEL=true is set for in-memory DB"
echo "• Build failures: Check all dependencies are in package.json"
echo ""
